<h1 style="font-size:300%">FUNCTIONAL DESIGN</h1>
...
View reported human-wildlife interactions (from smartphone apps).	… can adjust my management strategy accordingly.
