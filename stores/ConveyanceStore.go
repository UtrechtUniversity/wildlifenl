...
func NewConveyanceStore(db *sql.DB) *ConveyanceStore {
	s := ConveyanceStore{
		relationalDB: db,
		query: `
		SELECT c."ID", c."timestamp", u."ID", u."name", m."ID", m."name", m."severity", m."text", m."trigger", m."encounterMeters", m."encounterMinutes", e."ID", e."name", e."description", e."start", e."end", uu."ID", uu."name", COALESCE(ll."ID", '00000000-0000-0000-0000-000000000000'), COALESCE(ll."name", ''), COALESCE(n."ID",'00000000-0000-0000-0000-000000000000'), COALESCE(n."name",''), COALESCE(s."ID",'00000000-0000-0000-0000-000000000000'), COALESCE(s."name",''), COALESCE(s."commonName",''), COALESCE(r."ID",'00000000-0000-0000-0000-000000000000'), COALESCE(r."text",''), COALESCE(q."ID",'00000000-0000-0000-0000-000000000000'), COALESCE(q."text",''), COALESCE(q."description",''), COALESCE(q."index",0), COALESCE(q."allowMultipleResponse",FALSE), COALESCE(q."allowOpenResponse",FALSE), COALESCE(i."ID",'00000000-0000-0000-0000-000000000000'), COALESCE(i."timestamp",'2000-01-01'), COALESCE(i."notes",''), COALESCE(i."location",POINT(0,0)), COALESCE(t."ID",0), COALESCE(t."name",''), COALESCE(t."description",''), COALESCE(ts."ID",'00000000-0000-0000-0000-000000000000'), COALESCE(ts."name",''), COALESCE(ts."commonName",''), COALESCE(a."ID",'00000000-0000-0000-0000-000000000000'), COALESCE(a."text",''), COALESCE(a."index",0), COALESCE(l."ID",'00000000-0000-0000-0000-000000000000'), COALESCE(l."timestamp",'2000-01-01'), COALESCE(z."ID",'00000000-0000-0000-0000-000000000000'), COALESCE(z."deactivated",'200-01-01'), COALESCE(z."name",''), COALESCE(z."description",''), z."definition", COALESCE(ms."ID",'00000000-0000-0000-0000-000000000000'), COALESCE(ms."name",''), COALESCE(ms."commonName",'') 
		FROM "conveyance" c
...
func (s *ConveyanceStore) AddForAlarmIDs(alarmIDs []string) error {
	...
	query := `
		...
		AND (l."ID" IS NULL OR l."definition" @> @@z."definition")
	`
