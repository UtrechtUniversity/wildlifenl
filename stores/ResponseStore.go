...
func NewResponseStore(db *sql.DB) *ResponseStore {
	s := ResponseStore{
		relationalDB: db,
		query: `
		SELECT r."ID", r."timestamp", r."text", q."ID", q."text", q."description", q."index", q."allowMultipleResponse", q."allowOpenResponse", n."ID", n."name", n."identifier", e."ID", e."name", e."description", e."start", e."end", uu."ID", uu."name", COALESCE(ll."ID", '00000000-0000-0000-0000-000000000000'), COALESCE(ll."name", ''), i."ID", i."timestamp", i."notes", i."location", u."ID", u."name", t."ID", t."name", t."description", s."ID", s."name", s."commonName", s."category", s."advice", s."roleInNature", s."description", s."behaviour", COALESCE(a."ID", '00000000-0000-0000-0000-000000000000'), COALESCE(a."text", ''), COALESCE(a."index", 0)
		FROM "response" r
