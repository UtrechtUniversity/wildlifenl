...
type SightingReport struct {
	...
	PerceivedAnimalActivity      string       `json:"perceivedAnimalActivity" enum:"unknown,walking,eating/drinking,looking around,fleeing,resting,standing still,other..." doc:"The activity of the animal(s) as reported by the user."`
