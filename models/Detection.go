...
type DetectionRecord struct {
	...
	SpeciesID    string            `json:"speciesID,omitempty" format:"uuid" writeOnly:"true" required:"true" doc:"The ID of the species of the detected animal(s)."`
	...
	Animals      []DetectionAnimal `json:"animals,omitempty" required:"true" doc:"Information on the animals involved in this detection."`
}

type Detection struct {
	DetectionRecord
	Species Species `json:"species" doc:"The species of the animal(s) involved in this detection."`
	User    User    `json:"user" doc:"The user that owns the sensor that made this detection."`
}
