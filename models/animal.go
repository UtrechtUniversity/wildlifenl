...
type Animal struct {
	...
	LocationTimestamp *time.Time `json:"locationTimestamp,omitempty" format:"datetime" readOnly:"true" doc:"The moment that this animal's location was last updated."`
}
